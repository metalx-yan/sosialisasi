...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-6 col-8 align-self-center">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Data Binaan</li>
            </ol>
        </div>
    </div>
    ...
    <div class="card">
        ...
        @endphp
        <div class="card-body">
            <a href="{{ route('binaan.create') }}" class="btn btn-primary btn-sm">Tambah Binaan</a>
            <br>
            <br>
                    ...
                    @foreach ($data as $item)
                        <tr>
                            ...
                            <td>
                                <div class="row">
                                    <div class="col-md-2">
                                        <a href="{{ route('binaan.edit', $item->id ) }}" class="btn btn-warning btn-sm">Edit</a>
                                    </div>
                                    <div class="col-md-1"></div>
                                    <div class="col-md-2">
                                        <form action="{{ route('binaan.destroy', $item->id) }}" method="post">
                                            @csrf
                                            @method('DELETE')
