...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-6 col-8 align-self-center">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Buat Kekerasan</li>
            </ol>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('kekerasan.update', $get->id) }}" method="post">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-3">
                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <input type="text" name="pekerjaan" value="{{ $get->pekerjaan }}" class="form-control {{ $errors->has('pekerjaan') ? 'is-invalid' : ''}}" required>
                        {!! $errors->first('pekerjaan', '<span class="invalid-feedback">:message</span>') !!}
                    </div>
                    <div class="col-md-3">
                        <label for="">Jenis Kekerasan</label>
                        <input type="text" name="jenis_kekerasan" value="{{ $get->jenis_kekerasan }}" class="form-control {{ $errors->has('jenis_kekerasan') ? 'is-invalid' : ''}}" required>
                        {!! $errors->first('jenis_kekerasan', '<span class="invalid-feedback">:message</span>') !!}
                    </div>
                    <div class="col-md-3">
                    ...
                    <a href="{{ route('kekerasan.index') }}" class="btn btn-warning btn-sm">Back</a>
            </form>
        </div>
    </div>
</div>
