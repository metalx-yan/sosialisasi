...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-6 col-8 align-self-center">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Data Kekerasan</li>
            </ol>
        </div>
    </div>
    ...
    <div class="card">
        ...
        @endphp
        <div class="card-body">
            <a href="{{ route('kekerasan.create') }}" class="btn btn-primary btn-sm">Tambah Kekerasan</a>
            <br>
            <br>
                    ...
                    @foreach ($data as $item)
                        <tr>
                            ...
                            <td>
                                <div class="row">
                                    <div class="col-md-2">
                                        <a href="{{ route('kekerasan.edit', $item->id ) }}" class="btn btn-warning btn-sm">Edit</a>
                                    </div>
                                    <div class="col-md-1"></div>
                                    <div class="col-md-2">
                                        <form action="{{ route('kekerasan.destroy', $item->id) }}" method="post">
                                            @csrf
                                            @method('DELETE')
