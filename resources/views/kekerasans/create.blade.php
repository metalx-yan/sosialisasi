...
<div class="container-fluid">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('kekerasan.store') }}" method="post">
                @csrf
                <div class="row">
                    <div class="col-md-3">
                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <input type="text" name="pekerjaan" class="form-control {{ $errors->has('pekerjaan') ? 'is-invalid' : ''}}" required>
                        {!! $errors->first('pekerjaan', '<span class="invalid-feedback">:message</span>') !!}
                    </div>
                    <div class="col-md-3">
                        <label for="">Jenis Kekerasan</label>
                        <input type="text" name="jenis_kekerasan" class="form-control {{ $errors->has('jenis_kekerasan') ? 'is-invalid' : ''}}" required>
