...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-6 col-8 align-self-center">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Buat Pengemis</li>
            </ol>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('pengemis.update', $get->id) }}" method="post">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-3">
                ...
                <div class="row">
                    ...
                    <a href="{{ route('pengemis.index') }}" class="btn btn-warning btn-sm">Back</a>
            </form>
        </div>
    </div>
</div>
