...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-6 col-8 align-self-center">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Data Napza</li>
            </ol>
        </div>
    </div>
    ...
    <div class="card">
        ...
        @endphp
        <div class="card-body">
            <a href="{{ route('napza.create') }}" class="btn btn-primary btn-sm">Tambah Napza</a>
            <br>
            <br>
                    ...
                    @foreach ($data as $item)
                        <tr>
                            ...
                            <td>
                                <div class="row">
                                    <div class="col-md-2">
                                        <a href="{{ route('napza.edit', $item->id ) }}" class="btn btn-warning btn-sm">Edit</a>
                                    </div>
                                    <div class="col-md-1"></div>
                                    <div class="col-md-2">
                                        <form action="{{ route('napza.destroy', $item->id) }}" method="post">
                                            @csrf
                                            @method('DELETE')
