...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-6 col-8 align-self-center">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Data Pemulung</li>
            </ol>
        </div>
    </div>
    ...
    <div class="card">
        ...
        @endphp
        <div class="card-body">
            <a href="{{ route('pemulung.create') }}" class="btn btn-primary btn-sm">Tambah Pemulung</a>
            <br>
            <br>
                    ...
                    @foreach ($data as $item)
                        <tr>
                            ...
                            <td>
                                <div class="row">
                                    <div class="col-md-2">
                                        <a href="{{ route('pemulung.edit', $item->id ) }}" class="btn btn-warning btn-sm">Edit</a>
                                    </div>
                                    <div class="col-md-1"></div>
                                    <div class="col-md-2">
                                        <form action="{{ route('pemulung.destroy', $item->id) }}" method="post">
                                            @csrf
                                            @method('DELETE')
